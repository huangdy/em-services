...
@Endpoint
@Transactional
public class ResourceManagementServiceEndpoint
    ...
    public GetRequestedResourcesResponseDocument getRequestedResources(GetRequestedResourcesRequestDocument requestDoc) {

        GetRequestedResourcesRequest request = requestDoc.getGetRequestedResourcesRequest();
        WorkProduct[] workProducts = resourceManagementService.getRequestedResources(request.getIncidentID());
        GetRequestedResourcesResponseDocument responseDoc = GetRequestedResourcesResponseDocument.Factory.newInstance();
        GetRequestedResourcesResponse responseList = responseDoc.addNewGetRequestedResourcesResponse();
    ...
    public GetCommittedResourcesResponseDocument getCommittedResources(GetCommittedResourcesRequestDocument requestDoc) {

        GetCommittedResourcesRequest request = requestDoc.getGetCommittedResourcesRequest();
        WorkProduct[] workProducts = resourceManagementService.getCommittedResources(request.getIncidentID());
        GetCommittedResourcesResponseDocument responseDoc = GetCommittedResourcesResponseDocument.Factory.newInstance();
        GetCommittedResourcesResponse responseList = responseDoc.addNewGetCommittedResourcesResponse();
